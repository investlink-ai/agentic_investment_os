...
read-back. A finding, incomplete verification, or object-ID mismatch demotes an existing ready pull
request before the workflow can leave it pointing at affected state.
...
- Direct pull-request requests use the same publication-time evidence gates.
